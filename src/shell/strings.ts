...
export const t = {
  ...
  records: {
    ...
    totalTime: 'プレイ時間',
    stampTitle: 'スタンプだいし',
    stampNote: 'あそぶとスタンプ、メダルをとると わくの色がかわるよ',
    stampComplete: '100マス コンプリート！',
    bonusComplete: 'かくれゲーム コンプリート！',
    bonusMaster: 'かくれゲーム マスター！',
    bonusTitle: 'かくれゲーム',
    bonusNote: '100マスをぜんぶあそんで でてきた とくべつなゲーム',
    achievements: 'じっせき',
    globalSection: 'ぜんたい',
    openAll: 'すべて ひらく',
    closeAll: 'すべて とじる',
